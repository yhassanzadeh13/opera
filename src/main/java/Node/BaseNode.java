...
/**
The BaseNode interface represents a base interface for the node class to be available for the Simulator.Simulator.
...
public interface BaseNode{
    ...
    /**
     * Activated by the Simulator.Simulator on the creation of a new node and is used to initialize the node parameters
