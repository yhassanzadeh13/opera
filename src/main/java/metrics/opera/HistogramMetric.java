...
public class HistogramMetric implements Histogram {
   ...
   *                    equal to 0.5 value.
   */
  public HistogramMetric(String name, String namespace, String subsystem, String helpMessage, double[] buckets) {
